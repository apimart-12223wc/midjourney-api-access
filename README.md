# Midjourney API Access — How to Call It, What It Costs per Call
...
**[Get an API key](https://go.apimart.ai/k-3dfefb)** · **[Live pricing](https://go.apimart.ai/k-dc207b)** · **[Model page](https://go.apimart.ai/k-f2f473)** · [⚡ 60-second quickstart](#quickstart)
...
Midjourney has no public API for its Discord/web product, so **Midjourney API access** means a relay route: you submit an Imagine job, poll a task, and pay per call. This repository documents that path end to end — request shapes, per-call pricing, and outputs from four real jobs.
...
**Start with $1.** [Get an API key](https://go.apimart.ai/k-3dfefb) → [check live pricing](https://go.apimart.ai/k-dc207b) → [open Midjourney (`midjourney`) in the model library](https://go.apimart.ai/k-f2f473). The first call is three steps: submit, poll `task_id`, read the charged amount off the response.
<!-- /conv-kit:v1:cta -->
...
| --- | --- | --- |
| Open Midjourney on APIMart | <https://go.apimart.ai/k-f2f473> | `apimart.ai/model/midjourney` |
| Current pricing page | <https://go.apimart.ai/k-dc207b> | `apimart.ai/pricing` |
| Get an API key | <https://go.apimart.ai/k-3dfefb> | `apimart.ai/keys` |
